  ...
  function report (_ref) {
    ...
    if (conflictsCount > 0) {
      ...
      for (var _key in nodesTested.conflict) {
        var timeline = nodesTested.conflict[_key];
        data[_key] = {
          'tagName': timeline.tagName,
          'src/href': timeline.src || timeline.href || 'n/a',
          'innerText excerpt': timeline.innerText && timeline.innerText !== '' ? timeline.innerText.slice(0, 200) + '...' : '(empty)'
        };
      }
    ...
    if (noConflictsCount > 0) {
      ...
      for (var _key2 in nodesTested.noConflict) {
        var _timeline = nodesTested.noConflict[_key2];
        _data[_key2] = {
          'tagName': _timeline.tagName,
          'src/href': _timeline.src || _timeline.href || 'n/a',
          'innerText excerpt': _timeline.innerText && _timeline.innerText !== '' ? _timeline.innerText.slice(0, 200) + '...' : '(empty)'
        };
      }
    ...
    if (timeOutCount > 0) {
      ...
      for (var _key3 in timedOutTests) {
        var _timeline2 = timedOutTests[_key3];
        _data2[_key3] = {
          'tagName': _timeline2.tagName,
          'src/href': _timeline2.src || _timeline2.href || 'n/a',
          'innerText excerpt': _timeline2.innerText && _timeline2.innerText !== '' ? _timeline2.innerText.slice(0, 200) + '...' : '(empty)'
        };
      }
